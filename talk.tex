...
% I skip the part about rewriting history and file storage
\end{frame}
...
% keep all files and directories in "object"
% rename them with their hash
% keep the hash of the root directory in the message

% bonus: compress the whole thing
\end{frame}
